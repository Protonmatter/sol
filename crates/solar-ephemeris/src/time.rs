...
pub fn gmst_deg(jd_ut: f64) -> f64 {
    ...
    (280.46061837 + 360.98564736629 * (jd_ut - J2000) + 0.000387933 * t * t - t * t * t / 38710000.0)
        .rem_euclid(360.0)
}
...
mod tests {
    ...
    fn nutation_matches_meeus_example_22a() {
        ...
        assert!((dpsi * 3600.0 - (-3.788)).abs() < 0.5, "dpsi={}", dpsi * 3600.0);
        assert!((deps * 3600.0 - 9.443).abs() < 0.5, "deps={}", deps * 3600.0);
