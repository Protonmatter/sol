...
import { store } from "./js/store.js?v=dd4ea4c0de";
import { TOUR_STEPS } from "./js/config.js?v=dd4ea4c0de";
import { controls } from "./js/dom.js?v=dd4ea4c0de";
import { clamp } from "./js/format.js?v=dd4ea4c0de";
import { renderAll } from "./js/view.js?v=dd4ea4c0de";
import { updateModeButtons } from "./js/panels.js?v=dd4ea4c0de";
import { loadState } from "./js/data.js?v=dd4ea4c0de";
import { setTimelineFrame, goLive, togglePlay, runLiveEngine, stopPlay } from "./js/timeline.js?v=dd4ea4c0de";
import { startTour, endTour, showTourStep } from "./js/tour.js?v=dd4ea4c0de";
import { showTip, hideTip, isTipHidden } from "./js/tooltip.js?v=dd4ea4c0de";
import { enterSky, leaveSky, resizeSky } from "./js/sky.js?v=dd4ea4c0de";
import { enterOrrery, leaveOrrery } from "./js/orrery.js?v=dd4ea4c0de";
import { buildWavelengthBar } from "./js/wavelength.js?v=dd4ea4c0de";
import { buildSunCutaway } from "./js/sunlayers.js?v=dd4ea4c0de";
...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.register("sw.js?v=dd4ea4c0de").catch(() => { /* online-only */ });
}
