...
import { store } from "./js/store.js?v=481714bf23";
import { TOUR_STEPS } from "./js/config.js?v=481714bf23";
import { controls } from "./js/dom.js?v=481714bf23";
import { clamp } from "./js/format.js?v=481714bf23";
import { renderAll } from "./js/view.js?v=481714bf23";
import { updateModeButtons } from "./js/panels.js?v=481714bf23";
import { loadState } from "./js/data.js?v=481714bf23";
import { setTimelineFrame, goLive, togglePlay, runLiveEngine, stopPlay } from "./js/timeline.js?v=481714bf23";
import { startTour, endTour, showTourStep } from "./js/tour.js?v=481714bf23";
import { showTip, hideTip, isTipHidden } from "./js/tooltip.js?v=481714bf23";
import { enterSky, leaveSky, resizeSky } from "./js/sky.js?v=481714bf23";
import { enterOrrery, leaveOrrery } from "./js/orrery.js?v=481714bf23";
import { buildWavelengthBar } from "./js/wavelength.js?v=481714bf23";
import { buildSunCutaway } from "./js/sunlayers.js?v=481714bf23";
...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.register("sw.js?v=481714bf23").catch(() => { /* online-only */ });
}
