...
import { store } from "./js/store.js?v=821ff851a5";
import { TOUR_STEPS } from "./js/config.js?v=821ff851a5";
import { controls } from "./js/dom.js?v=821ff851a5";
import { clamp } from "./js/format.js?v=821ff851a5";
import { renderAll } from "./js/view.js?v=821ff851a5";
import { updateModeButtons } from "./js/panels.js?v=821ff851a5";
import { loadState } from "./js/data.js?v=821ff851a5";
import { setTimelineFrame, goLive, togglePlay, runLiveEngine, stopPlay } from "./js/timeline.js?v=821ff851a5";
import { startTour, endTour, showTourStep } from "./js/tour.js?v=821ff851a5";
import { showTip, hideTip, isTipHidden } from "./js/tooltip.js?v=821ff851a5";
import { enterSky, leaveSky, resizeSky } from "./js/sky.js?v=821ff851a5";
import { enterOrrery, leaveOrrery } from "./js/orrery.js?v=821ff851a5";
import { buildWavelengthBar } from "./js/wavelength.js?v=821ff851a5";
import { buildSunCutaway } from "./js/sunlayers.js?v=821ff851a5";
...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.register("sw.js?v=821ff851a5").catch(() => { /* online-only */ });
}
