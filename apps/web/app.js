...
import { store } from "./js/store.js?v=cad888c813";
import { TOUR_STEPS } from "./js/config.js?v=cad888c813";
import { controls } from "./js/dom.js?v=cad888c813";
import { clamp } from "./js/format.js?v=cad888c813";
import { renderAll } from "./js/view.js?v=cad888c813";
import { updateModeButtons } from "./js/panels.js?v=cad888c813";
import { loadState } from "./js/data.js?v=cad888c813";
import { setTimelineFrame, goLive, togglePlay, runLiveEngine, stopPlay } from "./js/timeline.js?v=cad888c813";
import { startTour, endTour, showTourStep } from "./js/tour.js?v=cad888c813";
import { showTip, hideTip, isTipHidden } from "./js/tooltip.js?v=cad888c813";
import { enterSky, leaveSky, resizeSky } from "./js/sky.js?v=cad888c813";
import { enterOrrery, leaveOrrery } from "./js/orrery.js?v=cad888c813";
import { buildWavelengthBar } from "./js/wavelength.js?v=cad888c813";
import { buildSunCutaway } from "./js/sunlayers.js?v=cad888c813";
...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.register("sw.js?v=cad888c813").catch(() => { /* online-only */ });
}
