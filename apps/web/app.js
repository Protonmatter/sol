...
import { store } from "./js/store.js?v=3f238fdfd4";
import { TOUR_STEPS } from "./js/config.js?v=3f238fdfd4";
import { controls } from "./js/dom.js?v=3f238fdfd4";
import { clamp } from "./js/format.js?v=3f238fdfd4";
import { renderAll } from "./js/view.js?v=3f238fdfd4";
import { updateModeButtons } from "./js/panels.js?v=3f238fdfd4";
import { loadState } from "./js/data.js?v=3f238fdfd4";
import { setTimelineFrame, goLive, togglePlay, runLiveEngine, stopPlay } from "./js/timeline.js?v=3f238fdfd4";
import { startTour, endTour, showTourStep } from "./js/tour.js?v=3f238fdfd4";
import { showTip, hideTip, isTipHidden } from "./js/tooltip.js?v=3f238fdfd4";
import { enterSky, leaveSky, resizeSky } from "./js/sky.js?v=3f238fdfd4";
import { enterOrrery, leaveOrrery } from "./js/orrery.js?v=3f238fdfd4";
import { buildWavelengthBar } from "./js/wavelength.js?v=3f238fdfd4";
import { buildSunCutaway } from "./js/sunlayers.js?v=3f238fdfd4";
...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.register("sw.js?v=3f238fdfd4").catch(() => { /* online-only */ });
}
