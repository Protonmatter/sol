...
import { store } from "./js/store.js?v=c8dc738669";
import { TOUR_STEPS } from "./js/config.js?v=c8dc738669";
import { controls } from "./js/dom.js?v=c8dc738669";
import { clamp } from "./js/format.js?v=c8dc738669";
import { renderAll } from "./js/view.js?v=c8dc738669";
import { updateModeButtons } from "./js/panels.js?v=c8dc738669";
import { loadState } from "./js/data.js?v=c8dc738669";
import { setTimelineFrame, goLive, togglePlay, runLiveEngine, stopPlay } from "./js/timeline.js?v=c8dc738669";
import { startTour, endTour, showTourStep } from "./js/tour.js?v=c8dc738669";
import { showTip, hideTip, isTipHidden } from "./js/tooltip.js?v=c8dc738669";
import { enterSky, leaveSky, resizeSky } from "./js/sky.js?v=c8dc738669";
import { enterOrrery, leaveOrrery } from "./js/orrery.js?v=c8dc738669";
import { buildWavelengthBar } from "./js/wavelength.js?v=c8dc738669";
import { buildSunCutaway } from "./js/sunlayers.js?v=c8dc738669";
...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.register("sw.js?v=c8dc738669").catch(() => { /* online-only */ });
}
