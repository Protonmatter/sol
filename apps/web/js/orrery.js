...
import { store } from "./store.js?v=eec94024e8";
import { loadSkyEngine, systemSnapshot, systemPositions, SYSTEM_POSITIONS_ORDER } from "./skyEngine.js?v=eec94024e8";
import { BODY, PLANET_ORDER, STYLE_ID, AU_KM, poleVector, equToEcl } from "./bodyData.js?v=eec94024e8";
import { buildCelestial } from "./celestial.js?v=eec94024e8";
import { DWARFS, COMETS, PROBES, asOrbit, bodyXYZ, probeXYZ, buildBelts } from "./smallbodies.js?v=eec94024e8";
import { epochAccuracy, epochLabel } from "./accuracy.js?v=eec94024e8";
import {
...
} from "./orreryGalaxy.js?v=eec94024e8";
import { renderDetail, renderMoonDetail, renderSmallDetail } from "./orreryDetail.js?v=eec94024e8";
import { renderStarDetail } from "./starDetail.js?v=eec94024e8";
import { buildEarthMapSliced, buildFeatureMap } from "./surfacemap.js?v=eec94024e8";
import { moonOffsetAU, moonOrbitPath, systemScale, withinMoonValidity, aliasedByClock } from "./moonorbits.js?v=eec94024e8";
...
function loadTextures() {
  ...
  for (const [name, file] of Object.entries(TEXTURE_FILES)) {
    ...
    img.src = "textures/" + file + "?v=eec94024e8"; // ?v stamped by tools/build_web.py (busts cached textures)
  }
  ...
  ring.src = "textures/saturn_ring.png?v=eec94024e8";
...
async function buildGeneratedMaps() {
  ...
  try {
    const [geo, moons] = await Promise.all([
      import("./geography.js?v=eec94024e8"),
      import("./moons.js?v=eec94024e8"),
    ]);
    moonSet = moons;
...
async function enterOrreryInner() {
  ...
  try {
    ...
    const starCatPromise = starCat ? null : import("./starcatalog.js?v=eec94024e8");
    await loadSkyEngine();
