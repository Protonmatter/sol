...
import { MODE_COPY, APPLICATION_COPY, STAGE_PLAIN, SIGNAL_TERMS, LEGEND_TERMS } from "./config.js?v=3b7d0d5283";
import { text, textWithTitle, setPill } from "./dom.js?v=3b7d0d5283";
import { auroraAssessment } from "./aurora.js?v=3b7d0d5283";
import { stageFromActivity, plural, number, numberOrNa, compactNumberOrNa, humanizeId, formatUtc } from "./format.js?v=3b7d0d5283";
import {
...
} from "./selectors.js?v=3b7d0d5283";
