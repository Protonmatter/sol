...
import { MODE_COPY, APPLICATION_COPY, STAGE_PLAIN, SIGNAL_TERMS, LEGEND_TERMS } from "./config.js?v=cad888c813";
import { text, textWithTitle, setPill } from "./dom.js?v=cad888c813";
import { auroraAssessment } from "./aurora.js?v=cad888c813";
import { stageFromActivity, plural, number, numberOrNa, compactNumberOrNa, humanizeId, formatUtc } from "./format.js?v=cad888c813";
import {
...
} from "./selectors.js?v=cad888c813";
