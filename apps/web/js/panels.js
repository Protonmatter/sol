...
import { MODE_COPY, APPLICATION_COPY, STAGE_PLAIN, SIGNAL_TERMS, LEGEND_TERMS } from "./config.js?v=db2518988d";
import { text, textWithTitle, setPill } from "./dom.js?v=db2518988d";
import { auroraAssessment } from "./aurora.js?v=db2518988d";
import { stageFromActivity, plural, number, numberOrNa, compactNumberOrNa, humanizeId, formatUtc } from "./format.js?v=db2518988d";
import {
...
} from "./selectors.js?v=db2518988d";
