...
import { MODE_COPY, APPLICATION_COPY, STAGE_PLAIN, SIGNAL_TERMS, LEGEND_TERMS } from "./config.js?v=82b4db3ea4";
import { text, textWithTitle, setPill } from "./dom.js?v=82b4db3ea4";
import { auroraAssessment } from "./aurora.js?v=82b4db3ea4";
import { stageFromActivity, plural, number, numberOrNa, compactNumberOrNa, humanizeId, formatUtc } from "./format.js?v=82b4db3ea4";
import {
...
} from "./selectors.js?v=82b4db3ea4";
