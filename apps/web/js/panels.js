...
import { MODE_COPY, APPLICATION_COPY, STAGE_PLAIN, SIGNAL_TERMS, LEGEND_TERMS } from "./config.js?v=78434029fa";
import { text, textWithTitle, setPill } from "./dom.js?v=78434029fa";
import { auroraAssessment } from "./aurora.js?v=78434029fa";
import { stageFromActivity, plural, number, numberOrNa, compactNumberOrNa, humanizeId, formatUtc } from "./format.js?v=78434029fa";
import {
...
} from "./selectors.js?v=78434029fa";
