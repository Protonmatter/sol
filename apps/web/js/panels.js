...
import { MODE_COPY, APPLICATION_COPY, STAGE_PLAIN, SIGNAL_TERMS, LEGEND_TERMS } from "./config.js?v=939e4357e1";
import { text, textWithTitle, setPill } from "./dom.js?v=939e4357e1";
import { auroraAssessment } from "./aurora.js?v=939e4357e1";
import { stageFromActivity, plural, number, numberOrNa, compactNumberOrNa, humanizeId, formatUtc } from "./format.js?v=939e4357e1";
import {
...
} from "./selectors.js?v=939e4357e1";
