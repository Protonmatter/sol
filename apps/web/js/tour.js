...
import { TOUR_STEPS } from "./config.js?v=db2518988d";
import { text } from "./dom.js?v=db2518988d";
import { renderAll } from "./view.js?v=db2518988d";
import { updateModeButtons } from "./panels.js?v=db2518988d";
