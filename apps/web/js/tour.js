...
import { TOUR_STEPS } from "./config.js?v=5ab0f0aa9f";
import { text } from "./dom.js?v=5ab0f0aa9f";
import { renderAll } from "./view.js?v=5ab0f0aa9f";
import { updateModeButtons } from "./panels.js?v=5ab0f0aa9f";
