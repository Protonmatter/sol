...
import { TOUR_STEPS } from "./config.js?v=cad888c813";
import { text } from "./dom.js?v=cad888c813";
import { renderAll } from "./view.js?v=cad888c813";
import { updateModeButtons } from "./panels.js?v=cad888c813";
