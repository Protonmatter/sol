...
import { equToEcl } from "./bodyData.js?v=db2518988d";
import { bvToRGB } from "./starphysics.js?v=db2518988d";
import { CONSTELLATIONS as FIGURES } from "./constellations.js?v=db2518988d";
...
export { CONSTELLATIONS, CONSTELLATION_COUNT } from "./constellations.js?v=db2518988d";
