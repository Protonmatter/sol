...
import { equToEcl } from "./bodyData.js?v=5ab0f0aa9f";
import { bvToRGB } from "./starphysics.js?v=5ab0f0aa9f";
import { CONSTELLATIONS as FIGURES } from "./constellations.js?v=5ab0f0aa9f";
...
export { CONSTELLATIONS, CONSTELLATION_COUNT } from "./constellations.js?v=5ab0f0aa9f";
