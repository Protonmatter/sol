...
import { equToEcl } from "./bodyData.js?v=dcca6290db";
import { bvToRGB } from "./starphysics.js?v=dcca6290db";
import { CONSTELLATIONS as FIGURES } from "./constellations.js?v=dcca6290db";
...
export { CONSTELLATIONS, CONSTELLATION_COUNT } from "./constellations.js?v=dcca6290db";
