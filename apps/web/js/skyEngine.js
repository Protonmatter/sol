...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=3b7d0d5283";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=3b7d0d5283", { cache: "no-cache" });
