...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=821ff851a5";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=821ff851a5", { cache: "no-cache" });
