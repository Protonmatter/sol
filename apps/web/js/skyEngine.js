...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=70cf73dc6e";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=70cf73dc6e", { cache: "no-cache" });
