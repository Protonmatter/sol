...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=939e4357e1";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=939e4357e1", { cache: "no-cache" });
