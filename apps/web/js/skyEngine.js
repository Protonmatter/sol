...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=da86e109de";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=da86e109de", { cache: "no-cache" });
