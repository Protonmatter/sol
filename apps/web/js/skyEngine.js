...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=ae3573fc32";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=ae3573fc32", { cache: "no-cache" });
