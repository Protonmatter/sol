...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=82b4db3ea4";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=82b4db3ea4", { cache: "no-cache" });
