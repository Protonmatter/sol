...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=10c823e120";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=10c823e120", { cache: "no-cache" });
