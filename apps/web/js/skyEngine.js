...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=5ab0f0aa9f";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=5ab0f0aa9f", { cache: "no-cache" });
