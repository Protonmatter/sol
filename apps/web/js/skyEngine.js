...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=2313f632ec";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=2313f632ec", { cache: "no-cache" });
