...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=e1f941f1c0";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=e1f941f1c0", { cache: "no-cache" });
