...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=3f238fdfd4";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=3f238fdfd4", { cache: "no-cache" });
