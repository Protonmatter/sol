...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=c87fc00662";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=c87fc00662", { cache: "no-cache" });
