...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=046aee6623";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=046aee6623", { cache: "no-cache" });
