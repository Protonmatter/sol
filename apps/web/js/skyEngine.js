...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=dec4c45ce0";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=dec4c45ce0", { cache: "no-cache" });
