...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=1f188ecb07";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=1f188ecb07", { cache: "no-cache" });
