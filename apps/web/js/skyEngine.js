...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=90cbd4968b";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=90cbd4968b", { cache: "no-cache" });
