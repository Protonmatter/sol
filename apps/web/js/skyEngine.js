...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=78434029fa";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=78434029fa", { cache: "no-cache" });
