...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=cad888c813";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=cad888c813", { cache: "no-cache" });
