...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=d26fc7c93f";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=d26fc7c93f", { cache: "no-cache" });
