...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=f3c390bd85";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=f3c390bd85", { cache: "no-cache" });
