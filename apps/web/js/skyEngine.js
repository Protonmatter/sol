...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=cc9af050a1";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=cc9af050a1", { cache: "no-cache" });
