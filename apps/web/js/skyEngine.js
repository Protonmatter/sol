...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=6ad2a13ce2";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=6ad2a13ce2", { cache: "no-cache" });
