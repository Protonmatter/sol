...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=4a5f52993c";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=4a5f52993c", { cache: "no-cache" });
