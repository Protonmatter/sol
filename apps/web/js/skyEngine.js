...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=658b334e69";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=658b334e69", { cache: "no-cache" });
