...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=db2518988d";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=db2518988d", { cache: "no-cache" });
