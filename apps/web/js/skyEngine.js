...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=19db56fd16";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=19db56fd16", { cache: "no-cache" });
