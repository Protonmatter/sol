...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=c8dc738669";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=c8dc738669", { cache: "no-cache" });
