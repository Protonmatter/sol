...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=32deafc09e";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=32deafc09e", { cache: "no-cache" });
