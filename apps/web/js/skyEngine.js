...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=dd4ea4c0de";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=dd4ea4c0de", { cache: "no-cache" });
