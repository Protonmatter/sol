...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=e8844e92f6";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=e8844e92f6", { cache: "no-cache" });
