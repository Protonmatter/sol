...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=2f9e27e79f";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=2f9e27e79f", { cache: "no-cache" });
