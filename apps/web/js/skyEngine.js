...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=a35b99fa20";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=a35b99fa20", { cache: "no-cache" });
