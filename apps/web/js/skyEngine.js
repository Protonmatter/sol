...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=481714bf23";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=481714bf23", { cache: "no-cache" });
