...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=6872c68498";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=6872c68498", { cache: "no-cache" });
