...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=ebbe92e1cf";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=ebbe92e1cf", { cache: "no-cache" });
