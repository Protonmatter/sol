...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=ce68304674";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=ce68304674", { cache: "no-cache" });
