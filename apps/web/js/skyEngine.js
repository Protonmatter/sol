...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=adefd395e5";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=adefd395e5", { cache: "no-cache" });
