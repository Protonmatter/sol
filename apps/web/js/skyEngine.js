...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=419de7192c";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=419de7192c", { cache: "no-cache" });
