...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=d78cbba4d4";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=d78cbba4d4", { cache: "no-cache" });
