...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=adc45b0b25";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=adc45b0b25", { cache: "no-cache" });
