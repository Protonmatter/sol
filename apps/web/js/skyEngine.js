...
import { assertEphemerisSnapshotV2 } from "./ephemerisContract.js?v=9f1426a7dc";
...
export function loadSkyEngine() {
  ...
  loadPromise = (async () => {
    ...
    const response = await fetch("pkg/solar_ephemeris.wasm?v=9f1426a7dc", { cache: "no-cache" });
