...
- Transiting moons cast their umbra/penumbra on the parent disc and darken inside its shadow
  ...
  shadow does not sit under the drawn moon. Moon luminance is albedo-driven (JPL Horizons
  physical-data blocks) through the sRGB transfer; `tools/validate_body_motion.py` gates every
