...
import {nearGroundVisibilityFixtures,genericSunReference,NEAR_GROUND_VISIBILITY_VERSION} from './atmosphere_visibility_fixtures.mjs';
...
const genericSunSource=genericSunReference(REFERENCE_ATMOSPHERE_GLSL);
