...
present, and falls back to its procedural shader for any that are missing. The textures are a
COMMITTED baseline (deploys must not depend on a third-party host being up — see .gitignore);
this script refreshes them, it is not required to obtain them.
