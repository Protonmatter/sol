...
const {getAtmosphereProfile,atmosphereUniformValues}=await module('js/atmosphereOptics.js');
...
assert.equal(hash(Buffer.from(JSON.stringify(profile))),field.profile_sha256,'Field belongs to this exact profile');
